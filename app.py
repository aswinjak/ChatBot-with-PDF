...
# Load the conversational chain with a specific prompt template for Gemini
...
def main():
    ...
    if "model_choice" not in st.session_state:
        st.session_state.model_choice = "Select Model" 
    ...
    user_question = st.text_input("Ask a Question or Request a Summary of the PDF Files")
...
#     st.session_state.model_choice = st.sidebar.selectbox(
#         "Select a model:",
#         options=["Gemini", "Ollama"],  # Add your models here
